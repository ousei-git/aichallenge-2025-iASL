...
: ${AMENT_CURRENT_PREFIX:="/aichallenge/install/imu_gnss_poser"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/imu_gnss_poser/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/imu_gnss_poser/environment/path.sh"
