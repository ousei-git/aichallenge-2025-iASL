...
#define NODE_MAIN_LOGGER_NAME "actuation_cmd_converter"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libaichallenge_awsim_adapter.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ActuationCmdConverter>";
