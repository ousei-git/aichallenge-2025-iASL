...
: ${AMENT_CURRENT_PREFIX:="/aichallenge/install/goal_pose_setter"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/goal_pose_setter/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/goal_pose_setter/environment/path.sh"
