...
#define NODE_MAIN_LOGGER_NAME "gnss_poser"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libgnss_poser_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<gnss_poser::GNSSPoser>";
