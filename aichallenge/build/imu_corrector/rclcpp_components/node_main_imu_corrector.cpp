...
#define NODE_MAIN_LOGGER_NAME "imu_corrector"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libimu_corrector_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<imu_corrector::ImuCorrector>";
