...
: ${AMENT_CURRENT_PREFIX:="/aichallenge/install/simple_trajectory_generator"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/simple_trajectory_generator/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/simple_trajectory_generator/environment/path.sh"
