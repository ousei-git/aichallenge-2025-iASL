...
: ${AMENT_CURRENT_PREFIX:="/aichallenge/install/simple_pure_pursuit"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/simple_pure_pursuit/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/simple_pure_pursuit/environment/path.sh"
