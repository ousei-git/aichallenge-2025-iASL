...
: ${AMENT_CURRENT_PREFIX:="/aichallenge/install/racing_kart_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/racing_kart_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/racing_kart_description/environment/path.sh"
