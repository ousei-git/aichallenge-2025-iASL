...
: ${AMENT_CURRENT_PREFIX:="/aichallenge/install/aichallenge_system_launch"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/aichallenge_system_launch/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/aichallenge_system_launch/environment/path.sh"
