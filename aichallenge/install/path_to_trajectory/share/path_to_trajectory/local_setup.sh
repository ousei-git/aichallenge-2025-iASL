...
: ${AMENT_CURRENT_PREFIX:="/aichallenge/install/path_to_trajectory"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/path_to_trajectory/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/path_to_trajectory/environment/path.sh"
